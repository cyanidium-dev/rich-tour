    ...
    <section className="mb-[74px] xl:mb-[145px]">
      <Container>
        <div className="relative flex flex-col xl:flex-row gap-y-7 xl:gap-x-[46px] items-center xl:items-start pb-[60px] xl:pb-0 xl:pt-2">
          <div className="absolute top-0 xl:top-[calc(50%+16px)] left-[calc(50%-1px)] xl:left-[4px] -z-10 w-[2px] xl:w-[calc(100%-4px)] h-full xl:h-[2px] bg-gradient-to-b xl:bg-gradient-to-r from-main to-black">
          ...
          <ul className="flex flex-col xl:flex-row items-center gap-y-[90px] xl:gap-x-[49px]">
