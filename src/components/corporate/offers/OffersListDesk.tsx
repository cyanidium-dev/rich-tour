...
export default function OffersListDesk() {
  return (
    <div className="hidden md:flex gap-5">
      ...
      <div className="relative flex items-end w-[calc(33.3%-10px)] aspect-[360/484] p-5 lg:p-8 rounded-[12px] overflow-hidden">
        <Image
      ...
      <div className="flex flex-col justify-between w-[calc(66.7%-10px)]">
        {/* Правий блок */}
        <div className="relative flex items-end aspect-[740/194] p-5 lg:p-8 rounded-[12px] overflow-hidden">
          <Image
