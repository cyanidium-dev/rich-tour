...
import AgencyInfoSection from "@/components/agency/menu/content/AgencyInfoSection";

export default function AgencySettingsContent({ user }: { user: any }) {
  return (
    <Container className="flex flex-col gap-6 xl:flex-row-reverse xl:justify-between">
      <div className="xl:w-[40.6%]">
        ...
        >
          Оновлюйте контактні дані, логін та реквізити агенції для роботи з кабінетом.
        </AnimatedWrapper>
        <AnimatedWrapper
